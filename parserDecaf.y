...
Fields: %empty
      |  Fields Field {$$ = new Nodo("Fields",num_lines,num_caracteres,"NA",$1,$2,NULL);};
...
VariableDecls: /*empty*/
	     | VariableDecls VariableDecl {$$ = new Nodo("VariableDecls",num_lines,num_caracteres,"NA",$1,$2,NULL);};
