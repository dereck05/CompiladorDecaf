...
Decls: Decl {$$ = new Nodo("Decls",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| Decls Decl {$$ = new Nodo("Decls",num_lines,num_caracteres,"NA",$2,NULL,NULL);};
...
FunctionDecl: TYPE IDENTIFIER OPENPAR Formals CLOSEPAR StmtBlock  {$$ = new Nodo("FunctionDecl",num_lines,num_caracteres,"NA",$6,NULL,NULL);}
	| VOID IDENTIFIER OPENPAR Formals CLOSEPAR StmtBlock {$$ = new Nodo("FunctionDecl",num_lines,num_caracteres,"NA",$6,NULL,NULL);};
...
CommaVariables: CommaVarList {$$ = new Nodo("CommaVariables",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| CommaVariables CommaVarList {$$ = new Nodo("CommaVariables",num_lines,num_caracteres,"NA",$2,NULL,NULL);};

CommaVarList: Variable {$$ = new Nodo("CommaVarList",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| CommaVarList COMMA Variable {$$ = new Nodo("CommaVarList",num_lines,num_caracteres,"NA",$3,NULL,NULL);};
...
CommaIdentifiers: CommaIdentList {$$ = new Nodo("CommaIdentifiers",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| CommaIdentifiers CommaIdentList {$$ = new Nodo("CommaIdentifiers",num_lines,num_caracteres,"NA",$2,NULL,NULL);};
...
Fields: %empty
      |  Fields Field {$$ = new Nodo("Fields",num_lines,num_caracteres,"NA",$2,NULL,NULL);};
...
Prototypes: /*empty*/
	  | Prototypes Prototype {$$ = new Nodo("Prototypes",num_lines,num_caracteres,"NA",$2,NULL,NULL);};
...
Stmts: /*empty*/
     | Stmts Stmt {$$ = new Nodo("Stmts",num_lines,num_caracteres,"NA",$2,NULL,NULL);};
...
CommaExpresions: CommaExpList {$$ = new Nodo("CommaExpresions",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| CommaExpresions CommaExpList {$$ = new Nodo("CommaExpresions",num_lines,num_caracteres,"NA",$2,NULL,NULL);};

CommaExpList: Expresion {$$ = new Nodo("CommaExpList",num_lines,num_caracteres,"NA",$1,NULL,NULL);}
	| CommaExpList COMMA Expresion {$$ = new Nodo("CommaExpList",num_lines,num_caracteres,"NA",$3,NULL,NULL);};
